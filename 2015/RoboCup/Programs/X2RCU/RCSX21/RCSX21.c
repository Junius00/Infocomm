...
int main(void)
{
    ...
    while (1)
    {
        ...
        SetLCD3Char(30,40,birval,YELLOW,BLACK);
        SetLCD3Char(30,60,cediff,YELLOW,BLACK);
        SetLCD3Char(60,0,firno,YELLOW,BLACK);
        SetLCD3Char(60,20,cpno,YELLOW,BLACK);
        SetLCD3Char(60,40,apno,YELLOW,BLACK);
        SetLCD3Char(60,60,birno,YELLOW,BLACK);
        ...
        if ( firval > 10||birval>10 )
        {
            if ( firval > birval )
            {
                ...
                else if (balldist > 30&&balldist < 135) {
                	if (us[2] > 30 && us[3] > 30) {
                		if (ballpos > 180) {
                			traM(270,(359-ballpos)*1.4,0);
                		}
                		else {
                		
                			traM(90,ballpos*1.4,0);
                		}
                	}
                	else if (us[2] < 30) {
                		traM(90,30,0);
