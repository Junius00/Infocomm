    ...
    while (1)
    {
        ...
        if ( us[1]>30&&us[2]>30&&us[3]>30 )
        {
            if ( firval > 10||birval>10 )
            {
                if ( firval > birval )
                {
                    if (80 < ballpos&&ballpos < 260)
                    {
                    	traM(180,30,0);
                    }
                    else if (ballpos>347||ballpos<13)
                    {
                    	if (balldist > 110)
                    	{
                    		traD = (360 - ((us[2] - us[3])/29)*us[1]/45)%360;
                    		traM(traD,55,0);
                    	}
                    	else if(balldist > 90&&balldist < 110)
                    	{
                    		traM(0,125-balldist,0);
                    	}
                    	else 
                    	{
                    		traM(ballpos,100-ballpos,0);
                    	}
                    }
                    else
                    {
                    	if (ballpos > 300&&ballpos < 60)
                    	{
                    		if (ballpos > 180)
                    		{
                    			traM(270,(360-ballpos)/1.2,0);
                    		}
                    		else
                    		{
                    	...
                    	else
                    	{
                    		if (ballpos > 180)
                    		{
                    			traM(260,(360-ballpos)/1.2,0);
                    		}
                    		else
                    		{
                    			traM(100,ballpos/1.2,0);
                    		}
